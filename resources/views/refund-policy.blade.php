...
<head>
    ...
    <title>Refund Policy | MyTalentIndia</title>
    ...
    <section class="py-16 flex-1">
        ...
        <div class="max-w-5xl mx-auto px-4">
            ...
            <div class="text-center mb-12">
                ...
                <span
                    class="inline-block bg-red-100 text-red-600 text-xs font-bold uppercase tracking-widest px-4 py-2 rounded-full">
                    Refund Policy
                </span>
            ...
            <div class="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 sm:p-10 space-y-8">
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Registration fees are generally non-refundable once payment is completed successfully.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Cancellation requests may be reviewed before final artwork submission.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-600">
                        ...
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-circle-check text-green-500 mt-1"></i>
                            Failed registration after successful payment deduction
                        </li>

                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-circle-check text-green-500 mt-1"></i>
                            Verified technical payment errors
                        </li>
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Approved refunds may take 5–10 working days to reflect in the original payment source.
                    </p>
                </div>
